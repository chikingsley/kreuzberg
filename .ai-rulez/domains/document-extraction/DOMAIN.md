...
### Result Structure
See: `crates/kreuzberg/src/types/extraction.rs` (ExtractionResult: content, mime_type, metadata, tables, detected_languages, chunks, images, pages, elements, djot_content, extracted_keywords, quality_score, processing_warnings)
